...
async function whatsappSignupRoutes(app) {
    ...
    app.post('/complete', { preHandler: leads_middleware_1.requireLeadAdmin }, async (req, reply) => {
    ...
    app.post('/refresh-business/:id', { preHandler: leads_middleware_1.requireLeadAdmin }, async (req, reply) => {
        const { id } = req.params || {};
