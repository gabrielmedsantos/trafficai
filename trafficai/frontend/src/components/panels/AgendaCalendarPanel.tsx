...
function CalendarApp() {
    ...
    return (
        // height:100%, sem margem negativa própria — o container em /agenda que já
        // cancela o padding da página e reserva o espaço certo pra esse painel,
        // descontando a barra de alternância de vista (Lista/Calendário).
        <div style={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden', background: 'var(--bg-primary)', fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
